...
SECRET_KEY = 'x$a@hp*8grtwcgbrxbq9bg2zbhlm1ebpqghq8!l2l9a_30^*jk'
...
AUTH_USER_MODEL = 'construct.CustomUser'
AUTHENTICATION_BACKENDS = ['construct.EmailBackend.EmailBackend']
